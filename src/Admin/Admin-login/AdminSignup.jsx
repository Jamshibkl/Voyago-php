...
function AdminSignup() {
  ...
  function handleSubmit() {
    if (admin !== "" && email !== "" && pass1 !== "" && pass2 !== "") {
      var url = "http://localhost/devtest/reactjs/Admin/registration.php";
      var headers = {
  ...
  function checkUser() {
    var url = "http://localhost/devtest/reactjs/Admin/checkuser.php";
    var headers = {
      Accept: "application/json",
      "Content-Type": "application/json",
    };
  ...
  function checkEmail() {
    var url = "http://localhost/devtest/reactjs/Admin/checkemail.php";
    var headers = {
      Accept: "application/json",
      "Content-Type": "application/json",
    };
        ...
        <div className="wrapper2">
          <section className="form3 login">
            ...
            <div className="form">
              ...
              <div className="link">
                Have already an account? <Link to="/admin-login">Login here</Link>
              </div>
            </div>
          </section>
        </div>
