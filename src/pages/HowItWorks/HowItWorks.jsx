          ...
          <div className="passenger_working">
            ...
            <div className="passenger_steps">
              ...
              <p className="steps_para">
                Begin by signing up on the Voyago platform. Fill in your
                details, and you're ready to embark on a new era of travel.
              </p>
            </div>
          </div>
          <div className="passenger_working">
            ...
            <div className="passenger_steps">
              ...
              <p className="steps_para">
                Customize your ride experience by setting preferences such as
                car type, music, and temperature. Your comfort is our priority.
              </p>
            </div>
          </div>
          <div className="passenger_working">
          ...
          <div className="for_driver_working">
            <div className="for_driver_steps">
              ...
              <p className="for_driver_para">
                ...
                requests that match your availability. It's about driving on
                your terms.
              </p>
            </div>
            <div className="for_line_divide">
